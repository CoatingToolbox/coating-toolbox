...
export const getToolingDimensions = (tablet = new Tablet2()) => {
   
   return {
       cupDepth: _getCupThickness(tablet.totalThickness, tablet.bandThickness)
   };
    
};


const _getCupThickness = (total, band) => {
    return (total - band) / 2;
};
    ...
    // }
    // get count() {
    //     return Math.ceil(this.batchWeight / this.weight);
    // }
    // set count(value) {
    //     this.batchWeight = value * this.weight;
    // }
    // get surfaceArea() {
    //     return this.count * this.totalArea;
    // }
    // get batchVolumeLargerThanTabletVolumes() {
    //     return this.volume > (this.count * this.totalVolume);
    // }
